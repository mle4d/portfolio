  ...
  return (
    <div className={styles.Projects}>
      ...
      <div className={styles.container}>
        <Project name="Soto" image={Soto} description="Collab Project.Vanilla JS Front End. Sorting game inspired by Marie Kondo" link="https://spark-joy.github.io/" github="https://github.com/spark-joy/spark-joy.github.io" />
